...
See [`doc/Example report.html`](../master/doc/Example%20report.html) for an example of the generated report (or [here](https://olliechick.co.nz/instagram_unfollowers_sample_report) for what the rendered html looks like).
